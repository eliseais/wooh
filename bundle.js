!(function(t) {
          ...
          o = (function(t) {
                ...
                if (this._timeline) {
                  ...
                  this._gc && this._enabled(!0, !1),
                    (this._totalTime === t && 0 !== this._duration) ||
                      (N.length && Q(), this.render(t, e, !1), N.length && Q());
                }
                return this;
              }),
                    ...
                    for (
                      ...
                      (o = s[r])
                        ? "string" != typeof o
                          ...
                          : "string" == typeof (o = s[r--] = R.selector(o)) &&
                            s.splice(r + 1, 1)
                        : s.splice(r--, 1);
                  else
                    (this._propLookup = {}),
            ...
            var N = [],
              ...
              q = function(t, e, n, i) {
                ...
                for (
                  ...
                  (c = o[a]),
                    (p +=
                      (u = e.substr(h, e.indexOf(c, h) - h)) || !a ? u : ","),
                    (h += u.length),
            ...
            (s._init = function() {
              ...
              (s._initProps = function(e, n, i, r, o) {
                ...
                this.vars))
                  if (((f = this.vars[s]), U[s]))
                    f &&
                      (f instanceof Array || (f.push && m(f))) &&
      ...
      function() {
            ...
            return function(t, u, c) {
              ...
              if (!b) {
                if (!(_ = "auto" === e.grid ? 0 : (e.grid || [1 / 0])[0])) {
                  for (
                    v = -1 / 0;
                    v < (v = c[_++].getBoundingClientRect().left) && _ < w;
        ...
        return (
          ...
          (d.from = function(t, e, n, r) {
            return this.add(
              ((n.repeat && l.TweenMax) || i.default).from(t, e, h(0, n)),
              r
            );
          }),
          ...
          (d.staggerTo = function(e, n, o, s, a, l, f, h) {
            var d,
              ...
              _ = o.cycle;
            for (
              "string" == typeof e && (e = i.default.selector(e) || e),
                r((e = e || [])) &&
                  (e = (function(t) {
                    var e,
                      n = [],
              ...
              (d = u(o)),
                y && ((d.startAt = u(y)), y.cycle && c(d.startAt, e, m)),
                _ &&
                  (c(d, e, m),
          ...
          (d.staggerFromTo = function(t, e, n, i, r, o, s, a, l) {
            return (
              (i.startAt = n), this.staggerTo(t, e, h(0, i, n), r, o, s, a, l)
            );
          }),
          ...
          (d.add = function(e, n, r, s) {
            ...
            if (
              (i.SimpleTimeline.prototype.add.call(this, e, n),
          ...
          (d.remove = function(t) {
            if (t instanceof i.Animation) {
              ...
              var e = (t._timeline = t.vars.useFrames
                ? i.Animation._rootFramesTimeline
                : i.Animation._rootTimeline);
              return (
                (t._startTime =
          ...
          (d._remove = function(t, e) {
            return (
              i.SimpleTimeline.prototype._remove.call(this, t, e),
              this._last
            ...
            if ((this._time !== p && this._first) || n || u || c) {
              if (
                ...
                for (
                  i = this._first;
                  i &&
                  ((o = i._next), f === this._time && (!this._paused || v));

                )
                  (i._active || (i._startTime <= f && !i._paused && !i._gc)) &&
                ...
                for (
                  i = this._last;
                  i &&
                  ((o = i._prev), f === this._time && (!this._paused || v));
          ...
          (d.getTweensOf = function(t, e) {
            ...
            for (
              o && this._enabled(!0, !0),
                r = (n = i.default.getTweensOf(t)).length;
              --r > -1;
                ...
                for (var e, n, i = 0, r = this._last, o = 999999999999; r; )
                  (e = r._prev),
                    ...
                    r._startTime < 0 &&
                      ...
                      (o = 0)),
                    (n = r._startTime + r._totalDuration / r._timeScale) > i &&
                      (i = n),
                    (r = e);
    ...
    !(function(e, n) {
      ...
      var T =
        ...
        (function(t) {
          ...
          function at(t, e, i, r) {
            ...
            if (
              !r &&
              ((e ? e.ownerDocument || e : b) !== p && h(e), (e = e || p), m)
            ) {
              if (11 !== x && (f = J.exec(t)))
                if ((o = f[1])) {
                  if (9 === x) {
          ...
          (at.attr = function(t, e) {
            ...
            var r = i.attrHandle[e.toLowerCase()],
              o =
                r && P.call(i.attrHandle, e.toLowerCase())
                  ? r(t, e, !m)
                  : void 0;
            return void 0 !== o
              ? o
              ...
              if (((n = n || []), 1 === p.length)) {
                ...
                for (
                  ...
                  if (
                    ...
                    if ((l.splice(o, 1), !(t = r.length && _t(l))))
      ...
      (w.filter = function(t, e, n) {
        ...
        w.fn.extend({
          ...
          is: function(t) {
            return !!P(
              this,
              "string" == typeof t && O.test(t) ? w(t) : t || [],
              !1
            ).length;
          }
        });
          ...
          function(t, e) {
            w.fn[t] = function(n, i) {
              ...
              return (
                ...
                this.length > 1 &&
                  (D[t] || w.uniqueSort(r), R.test(t) && r.reverse()),
                this.pushStack(r)
              );
            };
          }
      ...
      (w.Callbacks = function(t) {
        ...
        w.extend({
                        ...
                        u = function() {
                          ...
                          if (!(e < o)) {
                            ...
                            (u =
                              ...
                              m(u)
                                ? r
                                  ? u.call(t, s(o, n, L, r), s(o, n, I, r))
                                  : (o++,
                                    u.call(
                                      t,
                                      s(o, n, L, r),
                                      s(o, n, I, r),
                                      s(o, n, L, n.notifyWith)
                                    ))
                                : (i !== L && ((a = void 0), (l = [t])),
                                  (r || n.resolveWith)(a, l));
                          }
          ...
          when: function(t) {
            ...
            if (
              e <= 1 &&
              (F(t, s.done(a(n)).resolve, s.reject, !e),
        ...
        w.fn.extend({
          data: function(t, e) {
            ...
            if (void 0 === t) {
              if (
                this.length &&
                ((r = Z.get(o)), 1 === o.nodeType && !G.get(o, "hasDataAttrs"))
              ) {
                for (n = s.length; n--; )
                  s[n] &&
      ...
      function bt(t, e, n, i, r) {
        ...
        for (f.textContent = "", p = 0; (o = h[p++]); )
          if (i && w.inArray(o, i) > -1) r && r.push(o);
            ...
            ((u = rt(o)), (s = gt(f.appendChild(o), "script")), u && vt(s), n)
          )
      ...
      (w.event = {
              ...
              (p = m = (a = St.exec(e[u]) || [])[1]),
                ...
                p &&
                  ...
                  (h = l[p]) ||
                    ...
                    (f.setup && !1 !== f.setup.call(t, i, d, s)) ||
        ...
        dispatch: function(t) {
          ...
          if (
            ...
            for (
              s = w.event.handlers.call(this, a, u), e = 0;
        ...
        special: {
          ...
          click: {
            ...
            trigger: function(t) {
              var e = this || t;
              return (
                ht.test(e.type) && e.click && k(e, "input") && Pt(e, "click"),
                !0
              );
            },
            _default: function(t) {
      ...
      function It(t, e) {
        ...
        if (1 === e.nodeType) {
          if (
            G.hasData(t) &&
            ((o = G.access(t)), (s = G.set(e, o)), (u = o.events))
          )
            for (r in (delete s.handle, (s.events = {}), u))
              for (n = 0, i = u[r].length; n < i; n++)
                w.event.add(e, r, u[r][n]);
          Z.hasData(t) &&
            ((a = Z.access(t)), (l = w.extend({}, a)), Z.set(e, l));
        }
      }
      function Ft(t, e) {
        var n = e.nodeName.toLowerCase();
        "input" === n && ht.test(t.type)
          ? (e.checked = t.checked)
          : ("input" !== n && "textarea" !== n) ||
      ...
      function zt(t, e, n, i) {
        ...
        if (
          ...
          for (l = (a = w.map(gt(r, "script"), jt)).length; f < h; f++)
            (u = r),
              f !== p &&
                ((u = w.clone(u, !0, !0)), l && w.merge(a, gt(u, "script"))),
              n.call(t[f], u, f);
          if (l)
            for (
              c = a[a.length - 1].ownerDocument, w.map(a, Lt), f = 0;
              f < l;
              f++
            )
              (u = a[f]),
      ...
      w.extend({
        ...
        clone: function(t, e, n) {
          ...
          if (e)
            if (n)
              for (
                o = o || gt(t), s = s || gt(a), i = 0, r = o.length;
                i < r;
                i++
              )
                It(o[i], s[i]);
          ...
          return (
            (s = gt(a, "script")).length > 0 && vt(s, !l && gt(t, "script")), a
          );
        },
        cleanData: function(t) {
          for (
            var e, n, i, r = w.event.special, o = 0;
            void 0 !== (n = t[o]);
            o++
          )
            if ($(n)) {
        ...
        w.fn.extend({
          ...
          empty: function() {
            for (var t, e = 0; null != (t = this[e]); e++)
              1 === t.nodeType &&
                (w.cleanData(gt(t, !1)), (t.textContent = ""));
            return this;
          },
          clone: function(t, e) {
            return (
              ...
              function(t) {
                ...
                if (
                  ...
                  try {
                    for (; n < i; n++)
                      1 === (e = this[n] || {}).nodeType &&
                        (w.cleanData(gt(e, !1)), (e.innerHTML = t));
                    e = 0;
                  } catch (t) {}
                }
          ...
          replaceWith: function() {
            ...
            return zt(
              ...
              function(e) {
                ...
                w.inArray(this, t) < 0 &&
                  (w.cleanData(gt(this)), n && n.replaceChild(e, this));
              },
              t
            );
          }
        ...
        w.each(
          ...
          function(t, e) {
            w.fn[t] = function(t) {
              for (
                var n, i = [], r = w(t), o = r.length - 1, s = 0;
                s <= o;
                s++
              )
      ...
      function ee(t, e, n, i, r, o) {
        ...
        for (; s < 4; s += 2)
          "margin" === n && (l += w.css(t, n + nt[s], !0, r)),
            i
              ? ("content" === n && (l -= w.css(t, "padding" + nt[s], !0, r)),
                "margin" !== n &&
                  (l -= w.css(t, "border" + nt[s] + "Width", !0, r)))
              : ((l += w.css(t, "padding" + nt[s], !0, r)),
                "padding" !== n
                  ? (l += w.css(t, "border" + nt[s] + "Width", !0, r))
                  : (a += w.css(t, "border" + nt[s] + "Width", !0, r)));
        return (
          !i &&
            o >= 0 &&
            (l +=
              ...
              p))
                l ||
                  (g
                    ...
                    : (g = G.access(t, "fxshow", { display: u })),
                  o && (g.hidden = !m),
                  m && ft([t], !0),
                  h.done(function() {
                    for (i in (m || ft([t]), G.remove(t, "fxshow"), p))
                      w.style(t, i, p[i]);
                  })),
                  (l = fe(m ? g[i] : 0, i, h)),
                  i in g ||
          ...
          toggleClass: function(t, e) {
            ...
            return "boolean" == typeof e && i
              ...
              : this.each(function() {
                  var e, r, o, s;
                  if (i)
                    for (r = 0, o = w(this), s = _e(t); (e = s[r++]); )
                      o.hasClass(e) ? o.removeClass(e) : o.addClass(e);
                  else
                    (void 0 !== t && "boolean" !== n) ||
                      ((e = ye(this)) && G.set(this, "__className__", e),
                      this.setAttribute &&
                        this.setAttribute(
                          "class",
                          e || !1 === t
        ...
        w.extend({
          valHooks: {
            ...
            select: {
              ...
              set: function(t, e) {
                for (
                  var n, i, r = t.options, o = w.makeArray(e), s = r.length;
                  s--;
      ...
      w.extend(w.event, {
        trigger: function(e, n, r, o) {
          ...
          if (
            ...
            if (!o && !p.noBubble && !g(r)) {
              for (
                u = p.delegateType || y, be.test(u + y) || (a = a.parentNode);
                a;
                a = a.parentNode
              )
                v.push(a), (l = a);
        ...
        w.extend({
          ...
          ajax: function(e, n) {
            ...
            if (
              ...
              if (((S.readyState = 1), f && g.trigger("ajaxSend", [S, d]), c))
                return S;
              d.async &&
                d.timeout > 0 &&
            ...
            function E(e, n, i, a) {
              ...
              c ||
                ...
                u
                  ? (d.ifModified &&
                    ...
                    204 === e || "HEAD" === d.type
                      ...
                      : 304 === e
                      ? (T = "notmodified")
                      : ((T = b.state), (h = b.data), (u = !(p = b.error))))
                ...
                (_ = void 0),
                f &&
                  g.trigger(u ? "ajaxSuccess" : "ajaxError", [S, d, u ? h : p]),
                y.fireWith(m, [S, T]),
                f &&
      ...
      w.ajaxSetup({
            ...
            return (
              ...
              i.always(function() {
                void 0 === o ? w(t).removeProp(r) : (t[r] = o),
                  e[r] && ((e.jsonpCallback = n.jsonpCallback), $e.push(r)),
                  s && m(o) && o(s[0]),
                  (s = o = void 0);
              }),
              "script"
        ...
        (d.createHTMLDocument =
          (((Ue = i.implementation.createHTMLDocument("").body).innerHTML =
            "<form></form><form></form>"),
        ...
        (w.parseHTML = function(t, e, n) {
          return "string" != typeof t
            ...
            : ("boolean" == typeof e && ((n = e), (e = !1)),
              e ||
                (d.createHTMLDocument
                  ? (((r = (e = i.implementation.createHTMLDocument(
                      ""
        ...
        w.each(["top", "left"], function(t, e) {
          w.cssHooks[e] = Yt(d.pixelPosition, function(t, n) {
            if (n)
              return (n = Xt(t, e)), Bt.test(n) ? w(t).position()[e] + "px" : n;
          });
        }),
      ...
      return (
        (w.noConflict = function(e) {
          return (
            t.$ === w && (t.$ = Ze), e && t.jQuery === w && (t.jQuery = Ge), w
          );
        }),
        e || (t.jQuery = t.$ = w),
        w
  ...
  function(t, e, n) {
    ...
    var p = function() {
      ...
      d = {
        home: {
          enter: function(t, e) {
            var n = new o.default({ paused: !0 }),
              r = t.find(".wt-hero-particle"),
              s = t.find(".wt-hero-header h1"),
              a = new c.default(s, { type: "words" }),
              l = new c.default(a.words, { type: "words" }),
              f = t.find(".wt-hero-text, .wt-hero-form, .wt-hero-store-item"),
              h = t.find(".wt-hero-content"),
              d = t.find(".wt-hero-demo");
            return (
              (0, i.default)(a.words).css({
                overflow: "hidden",
                verticalAlign: "top",
                padding: "0.15em",
                margin: "-0.15em"
              }),
              n.to(r, 0.8, { opacity: 1 }, 0),
              e && n.fromTo(e[0], 2, { timeScale: 10 }, { timeScale: 0.7 }, 0),
              n.staggerFromTo(
                l.words,
                2.2,
                { opacity: 0, y: "120%", skewY: 5, transformOrigin: 0 },
                {
                  opacity: 1,
                  y: "0%",
                  skewY: 0,
              ...
              n.staggerFromTo(
                f,
                2,
                { opacity: 0, y: 80, skewY: 5, transformOrigin: 0 },
                {
                  opacity: 1,
                  y: 0,
                  skewY: 0,
              ...
              p() ||
                n.fromTo(
                  ...
                  2.5,
                  { y: 450 },
                  { y: 0, force3D: !0, ease: u.Expo.easeOut },
                  0.9
                ),
              d.length &&
                n.fromTo(
                  ...
                  2,
                  { y: 250, opacity: 0 },
                  { y: 0, opacity: 1, force3D: !0, ease: u.Expo.easeOut },
                  1.4
                ),
              n
            );
          ...
          magic: function(t, e) {
            ...
            o.mobile ||
              (t
                .find(
                  ".wt-hero-header,.wt-envelope,.wt-showreel,.wt-feature,.wt-advantage-header,.wt-advantage-details,.wt-description,.wt-getapp-fill,.wt-getapp-container"
                )
                .each(function() {
                  var t = this,
                    e = o.scrollTop(),
                    ...
                    s = function() {
                      (e = o.scrollTop()),
                        (function s() {
                          var a = o.scrollTop(),
                            l = o.simplify ? 0 : a - e,
                            u = Math.min(Math.max(-5, 0.15 * l), 5);
                          m
                            ? i ||
                              (r.default.to(t, 0.6, { skewY: 0, force3D: !0 }),
                              (i = !0))
                            : (r.default.set(t, { skewY: u, force3D: !0 }),
                              (i = !1)),
                            (e = a),
            ...
            return (
              s.each(function() {
                ...
                e.on("progress", function(t) {
                  o.tlMovement[0].timeScale(t.progress > 0.05 ? 0.2 : 0.7),
                    !l &&
                      t.progress > 0.05 &&
                      (a.each(function() {
                        this.play();
              ...
              o.mobile &&
                l.each(function() {
                  var t,
                    e = (0, i.default)(this).find(".wt-showreel-roll-item"),
          ...
          leave: function(t) {
            var e = new o.default({ paused: !0 }),
              n = t.find(".wt-content");
            return e.fromTo(n, 0.5, { opacity: 1 }, { opacity: 0 }, 0), e;
          }
        },
        about: {
          enter: function(t) {
            var e = new o.default({ paused: !0 }),
              ...
              r = new c.default(n, { type: "words" }),
              s = new c.default(r.words, { type: "words" }),
              a = t.find(
                ".wt-intro-text, .wt-intro-form, .wt-intro-store-item"
              ),
              l = t.find(".wt-intro-content"),
              f = t.find(".wt-change");
            return (
              (0, i.default)(r.words).css({
                overflow: "hidden",
                verticalAlign: "top",
                padding: "0.15em",
                margin: "-0.15em"
        ...
        faq: {
          enter: function(t) {
            var e,
              n,
              r,
              s = new o.default({ paused: !0 }),
              a = t.find(".wt-faq-header-title h1"),
              l = new c.default(a, { type: "words" }),
              f = new c.default(l.words, { type: "words" }),
              h = t.find(".wt-faq-footer"),
              p = t.find(".wt-faq-header-action-item");
            return (
              (0, i.default)(l.words).css({
                overflow: "hidden",
                verticalAlign: "top",
                padding: "0.15em",
                margin: "-0.15em"
        ...
        hero: {
          parallax: function(t) {
            ...
            return (
              e.set(o, { text: r[0] }, 0),
              e.set(o, { text: r[1] }, p() ? 0.05 : 0.15),
              e.set(o, { text: r[2] }, p() ? 0.15 : 0.3),
              e.set(o, { text: r[3] }, p() ? 0.2 : 0.45),
              p() ||
                (e.fromTo(s, 0.3, { opacity: 1 }, { opacity: 0 }, 0),
                e.fromTo(
                  n,
                  1,
                  { y: "0%" },
                  { y: "30%", force3D: !0, ease: u.Linear.easeNone },
                  0
                )),
              e.fromTo(a, 0.5, { rotation: 0 }, { rotation: -30 }, 0.3),
              e.add(function() {}, 1.7),
              e
            );
          }
          ...
          show: function(t) {
            ...
            return (
              e.fromTo(
                ...
                2,
                { scale: 0.8 },
                { scale: 1, ease: u.Expo.easeOut },
                0
              ),
              e.staggerFromTo(i, 1, { opacity: 0 }, { opacity: 1 }, 0.07, 0),
              e
            );
          },
          particleMove: function(t, e) {
            r.default.to(t, 0.5, e);
          }
        },
        showreel: {
          roll: function(t) {
        ...
        feature: {
          parallax: function(t) {
            ...
            return (
              e.fromTo(n, 0.4, { y: -80 }, { y: 80, ease: u.Linear.easeNone }),
              e
            );
          },
          shift: function(t, e) {
            var n = new o.default(),
              ...
              s = i.eq(e);
            return (
              r.default.killTweensOf(i),
              n.to(i, 0.6, { attr: { scale: 80 } }, 0),
              n.to(s, 0.6, { attr: { scale: 1 } }, 0),
              n
            );
          }
        },
        description: {
          parallax: function(t) {
            var e = new o.default(),
              ...
              i = n.find("img");
            return (
              n.length && e.fromTo(n, 0.4, { y: -80 }, { y: 80 }, 0),
              3 === i.length &&
                (e.fromTo(i[1], 0.4, { y: 30 }, { y: -30 }, 0),
                e.fromTo(i[2], 0.4, { y: 60 }, { y: -80 }, 0)),
              4 === i.length &&
                (e.fromTo(i[0], 0.4, { y: 70 }, { y: -10 }, 0),
                e.fromTo(i[2], 0.4, { y: 25 }, { y: -25 }, 0),
                e.fromTo(i[3], 0.4, { y: 40 }, { y: -40 }, 0)),
              e
            );
          }
        },
        getapp: {
          parallax: function(t) {
            var e = new o.default(),
              ...
              s = [new c.default(r, { type: "lines" }).lines, i],
              a = void 0;
            return (
              e.add(function() {
                a = -1;
        ...
        outro: {
          parallax: function(t) {
            var e = new o.default(),
              ...
              a = [new c.default(s, { type: "lines" }).lines, i, r],
              l = void 0;
            return (
              e.add(function() {
                l = -1;
        ...
        particle: {
          movement: function(t) {
            var e = new o.default({ paused: !0 });
            return (
              t.find(".wt-particle-item").each(function() {
                var n = new o.default({ repeat: -1 }),
                ...
                n.fromTo(
                  ...
                  i / 6,
                  { opacity: 0 },
                  { opacity: 1, ease: u.Linear.easeNone },
                  0
                ),
                  n.fromTo(
                    this,
                    ...
                    { y: -70, force3D: !0, ease: u.Linear.easeNone },
                    0
                  ),
                  e.add(n, r);
              }),
  ...
  function(t, e, n) {
    ...
    t.exports = function(t, e, n, d, m, g, v) {
      ...
      if (
        (P &&
          (w = c(P.call(new t()))) !== Object.prototype &&
          w.next &&
          (u(w, x, !0), i || "function" == typeof w[f] || s(w, f, p)),
        T &&
          O &&
          "values" !== O.name &&
          ((S = !0),
    ...
    t.exports = function(t, e, n, m, g, v) {
      ...
      if (
        ...
        k ||
          ...
          (b.constructor = _)),
          (O || C) && (T("delete"), T("has"), g && T("get")),
          (C || E) && T(w),
          v && b.clear && delete b.clear;
      } else
        (_ = m.getConstructor(e, t, g, w)), s(_.prototype, n), (a.NEED = !0);
      return (
        p(_, t),
        (x[t] = _),
        r(r.G + r.W + r.F * (_ != y), x),
  ...
  function(t, e, n) {
    ...
    t.exports =
      ...
      n(16)(function() {
        ...
        ? function(t, e) {
            for (
              var n = a(t), u = arguments.length, c = 1, f = o.f, h = s.f;
              u > c;
              ...
              for (
                var p,
                  d = l(arguments[c++]),
                  m = f ? r(d).concat(f(d)) : r(d),
                  g = m.length,
                  v = 0;
                g > v;

              )
                (p = m[v++]), (i && !h.call(d, p)) || (n[p] = d[p]);
            return n;
          }
        : u;
  },
      ...
      (r = function() {
        ...
        (t.version = "2.0.6"),
          ...
          (t.Controller = function(n) {
            var r,
              ...
              v = function() {
                u.refreshInterval > 0 &&
                  (o = window.setTimeout(S, u.refreshInterval));
              },
              y = function() {
                return u.vertical
              ...
              w = (this._setScrollPos = function(t) {
                u.vertical
                  ? d
                    ...
                    : (u.container.scrollTop = t)
                  : d
                  ? window.scrollTo(t, i.get.scrollTop())
                  : (u.container.scrollLeft = t);
              }),
              b = function() {
                if (g && f) {
            ...
            return (
              ...
              (this.loglevel = function(t) {
                return arguments.length
                  ? (u.loglevel != t && (u.loglevel = t), l)
                  : u.loglevel;
              }),
              (this.enabled = function(t) {
                return arguments.length
                  ? (g != t && ((g = !!t), l.updateScene(c, !0)), l)
                  : g;
              }),
              ...
              (function() {
                ...
                if (
                  ((u.container = i.get.elements(u.container)[0]), !u.container)
                )
                  throw (E(
                    1,
        ...
        (t.Controller.addOption = function(t, n) {
          ...
          (t.Scene = function(e) {
              ...
              return (
                i.type.Function(e)
                  ? (t = t.trim().split(" ")).forEach(function(t) {
                      ...
                      "*" != i &&
                        (m[i] || (m[i] = []),
                        m[i].push({ namespace: r || "", callback: e }));
                    })
                  : g(
                      1,
                  ...
                  g(3, "event fired:", r, n ? "->" : "", n || ""),
                    s &&
                      s.forEach(function(e, i) {
                        (o && o !== e.namespace) ||
                          e.callback.call(l, new t.Event(r, e.namespace, l, n));
                      });
              ...
              (this.progress = function(t) {
                if (arguments.length) {
                  ...
                  if (
                    ...
                    a &&
                      "DURING" !== n &&
                      (h("enter"), h("BEFORE" === n ? "start" : "end")),
                      h("progress"),
                      a &&
                        "DURING" !== c &&
                        (h("BEFORE" === c ? "start" : "end"), h("leave"));
                  }
                  return l;
                }
                return f;
            ...
            var v,
              ...
              _ = function() {
                (h = { start: p + u.offset }),
                  o &&
                    u.triggerElement &&
                    (h.start -= o.info("size") * u.triggerHook),
              ...
              b = function(t) {
                ...
                if (o && (n || p > 0)) {
                  ...
                  (p = e),
                    f &&
                      !t &&
                      l.trigger("shift", { reason: "triggerElementPosition" });
                }
              },
              x = function(t) {
                u.triggerHook > 0 &&
              ...
              S = function(t) {
                (t = arguments.length ? [t] : Object.keys(T)).forEach(function(
                  t,
                  e
                ) {
                  var n;
                ...
                l[t] ||
                  (l[t] = function(e) {
                    return arguments.length
                      ? ("duration" === t && (r = void 0),
                        E(t, e) &&
                          (l.trigger("change", { what: t, newval: u[t] }),
            ...
            var k = function(t) {
                if (v && o) {
                  ...
                  if (t || "DURING" !== c) {
                    ...
                    "fixed" != i.css(n, "position") &&
                      (i.css(n, { position: "fixed" }), C());
                    var a = i.get.offset(y.spacer, !0),
                      l =
                        u.reverse || 0 === u.duration
                          ? e.scrollPos - h.start
                          : Math.round(f * u.duration * 10) / 10;
                    (a[e.vertical ? "top" : "left"] += l),
                      i.css(y.element, { top: a.top, left: a.left });
                  }
                }
              },
              C = function() {
                if (v && o && y.inFlow) {
                  ...
                  y.relSize.width || y.relSize.autoFullWidth
                    ? t
                      ? i.css(v, { width: i.get.width(y.spacer) })
                      : i.css(v, { width: "100%" })
                    ...
                    y.pushFollowers &&
                      ((s["padding" + (e ? "Top" : "Left")] = u.duration * f),
              ...
              A = function() {
                o &&
                  ...
                  "DURING" === c &&
                  (((y.relSize.width || y.relSize.autoFullWidth) &&
                    i.get.width(window) != i.get.width(y.spacer.parentNode)) ||
                    (y.relSize.height &&
                      i.get.height(window) !=
            ...
            (this.setPin = function(t, e) {
              ...
              var c = v.parentNode.insertBefore(
              ...
              if (
                (o || i.extend(f, i.css(v, ["width", "height"])),
                i.css(c, f),
              ...
              return (
                y.relSize.width && i.css(c, { width: a.width }),
                y.relSize.height && i.css(c, { height: a.height }),
                c.appendChild(v),
                i.css(v, {
                  position: o ? "relative" : "absolute",
                  margin: "auto",
                  ...
                  if (("DURING" === c && k(!0), t || !o)) {
                    ...
                    y.spacer.parentNode.insertBefore(e, y.spacer),
                      ...
                      v.parentNode.hasAttribute(
                        "data-scrollmagic-pin-spacer"
                      ) || (i.css(v, v.___origStyle), delete v.___origStyle);
                  }
            ...
            return (
              ...
              (this.setClassToggle = function(t, e) {
                ...
                return 0 !== n.length && i.type.String(e)
                  ? (D.length > 0 && l.removeClassToggle(),
                    (R = e),
                    (D = n),
                    l.on("enter.internal_class leave.internal_class", function(
                      t
                    ) {
              ...
              (function() {
                for (var t in u)
                  a.hasOwnProperty(t) ||
                    (g(2, 'WARNING: Unknown option "' + t + '"'), delete u[t]);
                for (var e in a) O(e);
                S();
              })(),
              l
        ...
        (t.Scene.addOption = function(e, i, r, o) {
          e in n.defaults
            ...
            : ((n.defaults[e] = i), (n.validate[e] = r), o && n.shifts.push(e));
        }),
          ...
          for (e = 0; !c && e < u.length; ++e)
            (c = t[u[e] + "RequestAnimationFrame"]),
              (f =
                ...
                t[u[e] + "CancelRequestAnimationFrame"]);
          c ||
            (c = function(e) {
...
***************************************************************************** */ var o = function() {
    ...
    var nt = (function() {
      ...
      it = (function() {
        ...
        return (
          ...
          (t.prototype.update = function(t, e, n) {
            K(this.element, { display: n <= e ? "none" : "block" }),
    ...
    function ht(t) {
      ...
      function h(t) {
        return G(t, [u.element, u.thumb.element])
          ? ft.X
          : G(t, [c.element, c.thumb.element])
          ? ft.Y
          : void 0;
      }
      s(a, "click", function(e) {
        ...
        s(a, "mousedown", function(n) {
          if (G(n.target, [u.thumb.element, c.thumb.element])) {
            ...
            (r = h(s)),
              (i = { x: l.x - f.left, y: l.y - f.top }),
              (o = a.getBoundingClientRect()),
              K(t.containerEl, { "-user-select": "none" });
          }
        }),
      ...
      xt = (function() {
        function t(t, e) {
          ...
          (this.options = new X(e)),
            ...
            K(t, { overflow: "hidden", outline: "none" }),
        ...
        return (
              ...
              (function(t, e, n, i, r) {
                ...
                cancelAnimationFrame(ot.get(t)),
                  (function e() {
                    ...
                    if ((t.setPosition(h + d * r, p + m * r), n >= i))
          ...
          s([H(100, { leading: !0 })], t.prototype, "_updateDebounced", null),
          t
        );
      })(),
      Tt =
  ...
  function(t, e, n) {
    ...
    var u = {
      ...
      reqPage: function(t) {
        var e = t || this.req,
          n = i.default.ajax({ url: e.url, data: e.query });
        return (
          r.default.away(u),
          n.done(function(t) {
      ...
      goTo: function(t) {
        ...
        if (((u.req = s), s.triggerLeave && n)) {
          ...
          r.default.leave && r.default.leave(u),
            u.controllers[n] &&
              u.controllers[n].leave &&
              u.controllers[n].leave(u, a),
            a.done(function() {
              u.reqPage();
            });
        }
    ...
    (u.handleNavigation = function() {
      var t = function(t) {
        return (
          0 === t.indexOf("//") && (t = window.location.protocol + t),
          t
            .toLowerCase()
            .replace(/([a-z])?:\/\//, "$1")
            .split("/")[0]
      ...
      this.body.on("click", "a", function(e) {
        var n,
          r = (0, i.default)(this).attr("href");
        r &&
          "string" == typeof r &&
          (!((n = r).indexOf(":") > -1 || n.indexOf("//") > -1) ||
            t(window.location.href) === t(n)) &&
          (e.preventDefault(), u.goTo(r));
      });
    }),
  ...
  function(t, e, n) {
    ...
    var f = {
      init: function(t) {
        var e, n;
        (t.window = (0, r.default)(window)),
          (t.document = (0, r.default)(document)),
          (t.html = (0, r.default)("html")),
          (t.body = (0, r.default)("body")),
          (t.viewport = (0, r.default)("html,body")),
          (t.view = (0, r.default)("#view-main")),
          (t.content = (0, r.default)(".wt-content")),
          (t.loader = (0, r.default)(".wt-loader_overlay")),
          (t.navbar = (0, r.default)(".wt-navbar:first")),
          ...
          (t.cursor = (0, r.default)('<div class="wt-cursor -loading"></div>')),
          (t.tlMovement = []),
          (t.browser = (0, s.default)()),
          (t.mobile = t.browser.mobile || !!t.browser.os.match(/android/i)),
          t.html
            .removeClass("no-js")
            .addClass(t.mobile ? "mobile" : "desktop")
            .addClass(t.browser.name),
          t.window.on(
            "resize",
            (function e() {
              return (
          ...
          (t.scrollTo = function(e) {
            var n =
              ...
              s = r.default.extend(
                !0,
                { offsetY: 0, offsetX: 0, duration: 500, callback: null },
            ...
            if ("number" != typeof e) {
              ...
              (l = a.offset().top),
                (u = a.offset().left),
                t.scrollbar && ((l += t.scrollTop()), (u += t.scrollLeft()));
            } else (l = e), (u = n);
            (u += s.offsetX),
              (l += s.offsetY),
              t.scrollbar
                ? t.scrollbar.scrollTo(u, l, s.duration, s)
                : ((s.complete = s.callback),
                  t.viewport.animate({ scrollTop: l, scrollLeft: u }, s));
          }),
          t.body
            .on("mousedown", ".scrollbar-thumb", function() {
              t.simplify = !0;
            })
            .on("mouseup", function() {
              t.simplify = !1;
            }),
          t.mobile || (0, o.default)(),
          t.window.on(
            "scrolling",
            ((e = 0),
            function(n, i) {
          ...
          (t.navbarNavHandler = function(e) {
            ...
            t.navbar.removeClass("-open"),
              n &&
                (e.preventDefault(),
                e.stopPropagation(),
                t.scrollTo("#section-" + n, { duration: 1200 }));
          }),
          ...
          t.mobile ||
            t.body
              ...
              .on(
                "mousemove",
                ((n = !1),
                u.default.cursor.move(t.cursor, { x: 0, y: 0 }),
                function(e) {
                  var i = e.clientY,
                    r = e.clientX;
                  requestAnimationFrame(function() {
                    r < 50 || i < 50 || i > t.clientHeight - 50
                      ? n && (t.cursor.removeClass("-visible"), (n = !1))
                      : n || (t.cursor.addClass("-visible"), (n = !0)),
                      u.default.cursor.move(t.cursor, { x: r, y: i });
                  });
                })
              )
              .addClass("-cursor")
              .on("mouseenter", "a,input,textarea,button,iframe", function() {
      ...
      refresh: function(t) {
        t.mobile ||
          ...
          t.view.find(".wt-envelope").each(function() {
            ...
            t.on("mousemove", function(i) {
              var r = t.outerWidth(),
                ...
                g = 10 * -h;
              requestAnimationFrame(function() {
                u.default.envelope.particleMove(e, { x: p, y: d, force3D: !0 }),
          ...
          t.mobile ||
            t.body.find("[data-magnetic]").each(function() {
            ...
            (function i() {
              for (var s = 0; s < u.length; ) {
                ...
                if (
                  (!d &&
                    o.attributeName &&
                    (d = f.getAttribute(o.attributeName)),
                  p && d)
                ) {
                  if (r)
                    if (!o.validate || o.validate(d, p, f)) {
                      ...
                      if (g.length) {
                        ...
                        y ||
                          ...
                          y.send(),
                          (y._embeds = [])),
                          y._embeds.push({ parent: h, svg: p, id: v }),
                          e(y);
...
***************************************************************************** */ function u(
          ...
          (i.prototype.THROTTLE_TIMEOUT = 100),
            ...
            (i.prototype._computeTargetAndRootIntersection = function(e, n) {
              if ("none" != window.getComputedStyle(e).display) {
                for (
                  var i, r, o, a, u, c, f, h, p = s(e), d = l(e), m = !1;
                  !m;
  ...
  function(t, e, n) {
    ...
    h &&
      p &&
      (l((i = u.getConstructor(v, "WeakMap")).prototype, y),
      (a.NEED = !0),
      ...
      "Array",
      {
        from: function(t) {
          var e,
            ...
            y = c(h);
          if (
            (g && (m = i(m, d > 2 ? arguments[2] : void 0, 2)),
            null == y || (p == Array && a(y)))
          )
    ...
    i._gsScope._gsDefine(
      ...
      function() {
        ...
        return (
            ...
            if ((this._time !== d && this._first) || i || u || f) {
              if (
                ...
                for (
                  r = this._first;
                  r &&
                  ((a = r._next), h === this._time && (!this._paused || b));

                )
                  (r._active ||
                    (r._startTime <= this._time && !r._paused && !r._gc)) &&
                    (f === r && (this.pause(), (this._pauseTime = p)),
                    r._reversed
                      ? r.render(
                          (r._dirty ? r.totalDuration() : r._totalDuration) -
                            (t - r._startTime) * r._timeScale,
                ...
                for (
                  r = this._last;
                  r &&
                  ((a = r._prev), h === this._time && (!this._paused || b));
          ...
          (l.invalidate = function() {
            return (
              (this._locked = !1), r.default.prototype.invalidate.call(this)
            );
          }),
          ...
          (l.totalDuration = function(t) {
            return arguments.length
              ? -1 !== this._repeat && t
                ...
                : this
              : (this._dirty &&
                  (r.default.prototype.totalDuration.call(this),
                  (this._totalDuration =
                    -1 === this._repeat
                      ? 999999999999
    ...
    i._gsScope._gsDefine(
      ...
      function() {
        ...
        var u,
          ...
          it = function(t, e) {
            ...
            if ((e = e || J(t)))
              if ((n = e.length))
                for (; --n > -1; )
                  (-1 !== (r = e[n]).indexOf("-transform") && Nt !== r) ||
                    (o[r.replace(C, A)] = e.getPropertyValue(r));
              else
                for (n in e)
        ...
        (gt = new RegExp(gt + ")", "gi")),
          ...
          i.default.defaultStringFilter ||
            (i.default.defaultStringFilter = o.colorStringFilter);
        var vt = function(t, e, n, i) {
          ...
          wt =
            ((X._parseToProxy = function(t, e, n, i, r, o) {
              var s,
                a,
                l,
                u,
          ...
          xt = (o.parseComplex = function(t, e, n, i, r, s, a, l, c, f) {
            ...
            for (
              ...
              if (((_ = P[h]), (w = A[h] + ""), (T = parseFloat(_)) || 0 === T))
                a.appendXtra(
                  "",
                  T,
                  ut(w, T),
                  w.replace(y, ""),
                  !(!R || -1 === w.indexOf("px")) && Math.round,
                  !0
                );
              else if (r && gt.test(_))
                ...
                for (d = 0, p = 0; p < b.length; p++)
                  (O = b[p]),
                    ...
                    a.appendXtra(
                      ...
                      ut(x[p], O),
                      "",
                      !(!R || "px" !== _.substr(E + O.length, 2)) && Math.round,
                      0 === p
                    ),
                    (d = E + O.length);
                a["xs" + a.l] += _.substr(d);
        ...
        var kt,
          ...
          Bt =
            ((Mt = d || (/Android/i.test(Y) && !i._gsScope.chrome)),
            q.createElementNS &&
              qt.appendChild &&
              !Mt &&
              ((Ct = zt("svg", qt)),
            ...
            if (
              ...
              Dt &&
                ...
                ((l = t.parentNode) && t.offsetParent) ||
                  ((s = 1), (a = t.nextSibling), qt.appendChild(t)),
                (n =
                  !(i = tt(t, Nt, null, !0)) ||
                  "none" === i ||
            ...
            if (
              ...
              if (16 === s.length) {
                var g,
                  ...
                  L = Math.atan2(k, M);
                h.zOrigin &&
                  ((R = P * (N = -h.zOrigin) - s[12]),
                  (D = A * N - s[13]),
                  (N = M * N + h.zOrigin - s[14])),
                  (h.rotationX = L * I),
                  L &&
                    ((g = E * (_ = Math.cos(-L)) + P * (w = Math.sin(-L))),
                    (v = O * _ + A * w),
                    (y = k * _ + M * w),
                    (P = E * -w + P * _),
                    (A = O * -w + A * _),
                  ...
                  (h.rotationY = L * I),
                  L &&
                    ((v = x * (_ = Math.cos(-L)) - A * (w = Math.sin(-L))),
                    (y = T * _ - M * w),
                    (A = x * w + A * _),
                    (M = T * w + M * _),
                    (j = S * w + j * _),
                  ...
                  (h.rotation = L * I),
                  L &&
                    ((g = b * (_ = Math.cos(L)) + x * (w = Math.sin(L))),
                    (v = E * _ + O * w),
                    (y = P * _ + A * w),
                    (x = x * _ - b * w),
                    (O = O * _ - E * w),
                  ...
                  (L = Math.atan2(E, O)),
                  (h.scaleX =
                    ((1e5 * Math.sqrt(b * b + x * x + T * T) + 0.5) | 0) / 1e5),
                  (h.scaleY =
                    ((1e5 * Math.sqrt(O * O + k * k) + 0.5) | 0) / 1e5),
                  (h.scaleZ =
                    ((1e5 * Math.sqrt(P * P + A * A + M * M) + 0.5) | 0) / 1e5),
                  (b /= h.scaleX),
                  (E /= h.scaleY),
                  (x /= h.scaleX),
                  (O /= h.scaleY),
                  ...
                  (h.z = N),
                  h.svg &&
                    ((h.x -= h.xOrigin - (h.xOrigin * b - h.yOrigin * E)),
                ...
                (h.x = s[4] || 0),
                  ...
                  Lt &&
                    ...
                    (h.scaleZ = 1)),
                  h.svg &&
                    ((h.x -= h.xOrigin - (h.xOrigin * z + h.yOrigin * B)),
          ...
          Vt = function(t) {
            ...
            if (f) {
              ...
              if (
                (null != i.ox &&
                  ((_ +=
                    (h = (i.oxp ? m * i.ox * 0.01 : i.ox) - m / 2) -
                    (h * s +
                      (p = (i.oyp ? g * i.oy * 0.01 : i.oy) - g / 2) * a)),
                  (w += p - (h * l + p * u))),
                (y += v
                  ? ", Dx=" +
                    ((h = m / 2) - (h * s + (p = g / 2) * a) + _) +
                ...
                for (
                  h = i.ieOffsetX || 0,
                    ...
                    i.ieOffsetX = Math.round(
                      (m - ((s < 0 ? -s : s) * m + (a < 0 ? -a : a) * g)) / 2 +
                        _
                    ),
                    i.ieOffsetY = Math.round(
                      (g - ((u < 0 ? -u : u) * g + (l < 0 ? -l : l) * m)) / 2 +
                        w
                    ),
                    Tt = 0;
                  Tt < 4;
                  ...
                  (E =
                    (n =
                      -1 !== (b = f[(S = st[Tt])]).indexOf("px")
                        ? parseFloat(b)
                        : et(this.t, S, parseFloat(b), b.replace(x, "")) ||
                          0) !== i[S]
                      ? Tt < 2
                        ? -i.ieOffsetX
                        : -i.ieOffsetY
            ...
            if (
              ...
              S || F || D
                ? ((S *= L),
                  ...
                  D &&
                    ((A +=
                      x.xOrigin - (x.xOrigin * n + x.yOrigin * i) + x.xOffset),
                    (M +=
                      x.yOrigin - (x.xOrigin * o + x.yOrigin * s) + x.yOffset),
                    kt &&
                      (x.xPercent || x.yPercent) &&
                      ((g = this.t.getBBox()),
                      (A += 0.01 * x.xPercent * g.width),
              ...
              (c = 1),
                ...
                (S = O * L) &&
                  ...
                  (o *= v)),
                (S = E * L) &&
                  ((e = i * (v = Math.cos(S)) + r * (y = Math.sin(S))),
                  (_ = s * v + a * y),
                  (u = c * y),
                  (p = d * y),
                  (r = i * -y + r * v),
            ...
            "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin",
            {
              parser: function(t, e, i, r, s, a, l) {
                ...
                return (
                      ...
                      ? ((p = !0),
                        ...
                        k ||
                          (k =
                            ...
                            "px"),
                        (k += ""),
                        ((s = new wt(x, w, 0, 0, s, -1, "transformOrigin")).b =
                          x[w]),
                        (s.plugin = a),
                        Lt
                          ? ((f = O.zOrigin),
                  ...
                  p &&
                    (r._transformType =
                      (O.svg && kt) || (!h && 3 !== this._transformType)
                        ? 2
                        : 3),
                  u && (l.scale = u),
                  s
            ...
            parser: function(t, i, r, o, s, a) {
              ...
              for (
                ...
                this.p.indexOf("border") && (S[u] = Q(S[u])),
                  -1 !== (h = f = tt(t, S[u], n, !1, "0px")).indexOf(" ") &&
                  ...
                  (w = "=" === p.charAt(1))
                    ? ((m = parseInt(p.charAt(0) + "1", 10)),
                      (p = p.substr(2)),
                      (m *= parseFloat(p)),
                      (y = p.substr((m + "").length - (m < 0 ? 1 : 0)) || ""))
                    : ((m = parseFloat(p)), (y = p.substr((m + "").length))),
                  "" === y && (y = e[r] || _),
                  y !== _ &&
                    ((b = et(t, "borderLeft", d, _)),
                    (x = et(t, "borderTop", d, _)),
                    "%" === y
                      ? ((h = (b / g) * 100 + "%"), (f = (x / v) * 100 + "%"))
                      : "em" === y
                      ? ((h = b / (T = et(t, "borderLeft", 1, "em")) + "em"),
                        (f = x / T + "em"))
                      : ((h = b + "px"), (f = x + "px")),
                    w &&
                      ((p = parseFloat(h) + m + y),
          ...
          Et("backgroundPosition", {
            ...
            parser: function(t, e, i, r, o, s) {
              ...
              if (
                ...
                v.split(",").length < 2 &&
                (h = tt(t, "backgroundImage").replace(P, "")) &&
                "none" !== h
              ) {
                for (
                  a = g.split(" "),
        ...
        Et("className", {
          parser: function(e, i, r, o, s, a, l) {
            var u,
              ...
              m = e.style.cssText;
            if (
              (((s = o._classNamePT = new wt(e, r, 0, 0, s, 2)).setRatio = Kt),
              (s.pr = -11),
              (t = !0),
              (s.b = d),
              (c = it(e, n)),
        ...
        for (
          Et("clearProps", {
            parser: function(e, n, i, r, o) {
              return (
                ((o = new wt(e, i, 0, 0, o, 2)).setRatio = Jt),
                (o.e = n),
                (o.pr = -10),
                (o.data = r._tween),
                (t = !0),
                  ...
                  (y && O.test(p))
                    ? (y ||
                        (p =
                          ...
                          p.join(",") +
                          ")"),
                      (r = xt(w, s, h, p, !0, "transparent", r, 0, o)))
                    : y && j.test(p)
                    ? (r = xt(w, s, h, p, !0, null, r, 0, o))
                    : ((d =
                        (c = parseFloat(h)) || 0 === c
                          ? h.substr((c + "").length)
                          : ""),
  ...
  function(t, e, n) {
    ...
    var i = n(0),
      ...
      u = i._gsScope._gsDefine.plugin({
        ...
        init: function(t, e, n, i) {
          var o,
            s = t.nodeName.toUpperCase();
          if (
            ("function" == typeof e && (e = e(i, t)),
          ...
          for (
            this._delimiter = e.delimiter || "",
              ...
              o =
                (s = this._original.length - this._text.length) < 0
                  ? this._original
                  : this._text,
        ...
        set: function(t) {
          ...
          var e,
            ...
            o = (t * r + 0.5) | 0;
          this._hasClass
            ? ((e = this._newClass && 0 !== o),
              (n = this._oldClass && o !== r),
              (i =
                (e ? "<span class='" + this._newClass + "'>" : "") +
                this._text.slice(0, o).join(this._delimiter) +
                (e ? "</span>" : "") +
                (n ? "<span class='" + this._oldClass + "'>" : "") +
                this._delimiter +
            ...
            : (i =
                ...
                this._original.slice(o).join(this._delimiter)),
            this._svg
              ? (this._target.textContent = i)
              : (this._target.innerHTML =
                  "&nbsp;" === this._fillChar && -1 !== i.indexOf("  ")
                    ? i.split("  ").join("&nbsp;&nbsp;")
                    : i);
        }
      }),
    ...
    i._gsScope._gsDefine(
      ...
      function() {
        var t,
          ...
          n,
          r,
          o = i._gsScope.GreenSockGlobals || i._gsScope,
          s = o.com.greensock,
          a = 2 * Math.PI,
          l = Math.PI / 2,
          u = s._class,
        ...
        return (
          ...
          ((v = (t = u(
            ...
            !0
          )).prototype = new i.Ease()).constructor = t),
          (v.getRatio = function(t) {
            return (
          ...
          ((v = (e = u(
            ...
            !0
          )).prototype = new i.Ease()).constructor = e),
          (v.getRatio = function(t) {
            return (
          ...
          ((v = (n = u(
            ...
            function(t) {
              for (
                var e,
                  ...
                  d = !1 !== t.randomize,
                  m = !0 === t.clamp,
                  g = t.template instanceof i.Ease ? t.template : null,
            ...
            !0
          )).prototype = new i.Ease()).constructor = n),
          (v.getRatio = function(t) {
            var e = this._prev;
            if (t > e.t) {
        ...
        var e = t.GreenSockGlobals || t,
          ...
          s = function(t, e, n, i) {
            ...
            return (
              (n = n || r(t, null))
                ? (s =
                    (t = n.getPropertyValue(
                      e.replace(o, "-$1").toLowerCase()
                    )) || n.length
                      ? t
                      : n[e])
                : t.currentStyle && (s = (n = t.currentStyle)[e]),
              i ? s : parseInt(s, 10) || 0
            );
          },
          a = function(t) {
          ...
          _ = function(t, e, n, o, a, l, u) {
                ...
                ((_ = (p = g[c]).parentNode === t) || X || (W && !H)) &&
                  ...
                  B &&
                    (((p._isSplit && _) ||
                      ...
                      (w.push(p), (p._x -= k), v(p, t, F) && (p._wordEnd = !0)),
                    "BR" === p.nodeName &&
                    ...
                    !H && W
                      ? p._isSplit
                        ...
                        ? ((p._parent = p.parentNode),
                          ...
                          h--)
                        : _ ||
                          ((E = !p.nextSibling && v(p.parentNode, t, F)),
                      ...
                      : W &&
                        !p._isSplit &&
                        (e.span && (p.style.display = "inline"), j.push(p)))
                  : B || X
            ...
            if (B) {
              ...
              for (
                ...
                for (
                  w = B[c],
                    (T = i.createElement(z)).style.cssText =
                ...
                0 === h
                  ? (T.innerHTML = "&nbsp;")
                  : H || W || (y(T), d(T, String.fromCharCode(160), " ")),
                  X && ((T.style.width = S), (T.style.height = p._h + "px")),
                  t.appendChild(T);
              }
              t.style.cssText = x;
            }
            X &&
              (u > t.clientHeight &&
                ((t.style.height = u - M + "px"),
                t.clientHeight < u && (t.style.height = u + P + "px")),
              l > t.clientWidth &&
                ((t.style.width = l - R + "px"),
          ...
          w = function t(e, n, r, o) {
            ...
            if (3 !== e.nodeType || p > 1) {
              for (n.absolute = !1, a = 0; a < p; a++)
                (3 !== (f = h[a]).nodeType || /\S+/.test(f.nodeValue)) &&
                  (m &&
                    3 !== f.nodeType &&
                    "inline" === s(f, "display", null, !0) &&
            ...
            !(function(t, e, n, r) {
              ...
              for (
                ...
                if ((p = o.charAt(a)) === b && o.charAt(a - 1) !== b && a) {
                  for (s += S ? T : "", S = !1; o.charAt(a + 1) === b; )
                    (s += x), a++;
                  a === h - 1
                    ? (s += x)
                    : ")" !== o.charAt(a + 1) && ((s += x + n()), (S = !0));
                } else
                  "{" === p && "{{LT}}" === o.substr(a, 6)
                    ? ((s += _ ? r() + "{{LT}}</" + y + ">" : "{{LT}}"),
                      (a += 5))
                    : (p.charCodeAt(0) >= 55296 && p.charCodeAt(0) <= 56319) ||
                      (o.charCodeAt(a + 1) >= 65024 &&
                        o.charCodeAt(a + 1) <= 65039)
                    ? ((g = c(o.substr(a, 2))),
                      (v = c(o.substr(a + 2, 2))),
                      (f =
                        (g >= 127462 &&
      ...
      t ||
        ...
        t.Scene.extend(function() {
          ...
          (i.setTween = function(a, l, u) {
            var c;
            arguments.length > 1 &&
              (arguments.length < 3 && ((u = l), (l = 1)), (a = e.to(a, l, u)));
            try {
            ...
            if (
              (t && i.removeTween(),
              (t = c),
              a.repeat && -1 === a.repeat() && (t.repeat(-1), t.yoyo(a.yoyo())),
              i.tweenChanges() &&
                !t.tweenTo &&
                o(
                  2,
            ...
            (i.removeTween = function(e) {
              return (
                t &&
                  ...
                  o(
                    3,
                    "removed tween (reset: " + (e ? "true" : "false") + ")"
                  )),
                i
              );
            });
    ...
    var a = {
      init: function(t, e) {
        ...
        t.navbarLogo.on("click", function(e) {
          e.preventDefault(),
            e.stopPropagation(),
            t.scrollTo("header", { duration: 1200 });
        }),
            ...
            a.each(function() {
              ...
              t.on("mousemove", function(t) {
                var i = e.offset().top - window.pageYOffset,
                  ...
                  a = t.clientX - r;
                requestAnimationFrame(function() {
                  o.default.to(n[0], 1, { x: a, y: s, force3D: !0 }),
                    o.default.to(n[1], 1, { x: a, y: s, force3D: !0 }),
                    o.default.to(n[2], 0.7, { x: a, y: s, force3D: !0 });
                });
              });
            }),
          t.mobile ||
            s.find(".wt-showreel").each(function() {
              var t = (0, i.default)(this),
              ...
              t.on("mousemove", function(e) {
                var n = t.get(0).getBoundingClientRect(),
                  i = e.clientY - n.top,
                  s = e.clientX - n.left;
                o.default.to(r, 0.4, { y: i, x: s, force3D: !0 });
              }),
                ...
                n.on("mouseenter", function(t) {
                  var e = (0, i.default)(this).find(
                      ".wt-showreel-roll-item-img"
                    ),
                    n = e.find("video")[0];
                  o.default.to(e, 0.2, { opacity: 1, display: "block" }),
                    n.play();
                }),
                n.on("mouseleave", function() {
                  var t = (0, i.default)(this).find(
                      ".wt-showreel-roll-item-img"
                    ),
                    e = t.find("video")[0];
                  o.default.to(t, 0.2, {
          ...
          t.mobile ||
            s.find(".wt-advantage").each(function() {
              var t = (0, i.default)(this),
      ...
      enter: function(t, e) {
        t.view;
        this.tlEnter
          ? (this.tlEnter.eventCallback("onComplete", function() {
              return e.resolve();
            }),
            this.tlEnter.play())
          : e.resolve();
      ...
      leave: function(t, e) {
        ...
        t.tlMovement &&
          t.tlMovement.forEach(function(t) {
            return t.pause();
          }),
    ...
    var o = {
      init: function(t, e) {
        var n = this,
          r = t.view;
        t.mobile ||
          ((this.magic = i.default.about.magic(r, {
            app: t,
            controller: {
              refreshInterval: t.scrollbar ? 0 : 80,
    ...
    var s = {
      init: function(t, e) {
        ...
        s.find("[data-tab]").each(function() {
          ...
          t.mobile ||
            ((this.magic = r.default.faq.magic(s, {
              app: t,
              controller: {
                refreshInterval: t.scrollbar ? 0 : 80,
                container: t.scrollbar ? s[0] : window
